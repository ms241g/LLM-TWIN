...
from llm_enginerring.domain.cleaned_documents import (
...
class ChunkingDataHandler(Generic[ChunkT, CleanedDocumentT], ABC):
    """
    Abstract class for handling chunking data
    """
