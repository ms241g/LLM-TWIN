...
from llm_enginerring.application.preprocessing import ChunkingDispatcher, EmbeddingDispatcher
from llm_enginerring.domain.chunks import Chunk
from llm_enginerring.domain.embedded_chunks import EmbeddedChunk

@step
def chunk_and_embed(
    cleaned_documents: Annotated[list, "cleaned documents"],
